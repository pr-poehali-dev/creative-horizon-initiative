...
const ALEXEY_REACTIONS: Record<string, string> = {
  'привет': 'Не до приветствий! У вас критическая ситуация!',
  ...
  'нет': 'Это ещё хуже. Значит вы не замечаете слежки.',
...
export default function SupportChat() {
  ...
  const handleSend = () => {
    ...
    const reaction = Object.entries(ALEXEY_REACTIONS).find(([key]) => lower.includes(key))
